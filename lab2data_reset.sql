...
-- 5. DEPARTMENT (manager_employee_id is nullable; we'll set it after employees exist)
...
-- 12. PLANNED ACTIVITY (NO employee_id anymore)
...
-- 13. SALARY HISTORY (PK = employee_id + salary_date)
